package cn.llf.mybatis.dao.impl;

import cn.llf.mybatis.dao.BaseMybatisDao;
...
public class BaseMybatisDaoImpl<T,PK extends Serializable> extends SqlSessionDaoSupport implements
    ...
    public List<T> selectList(String statement, String mapKey,Object paramObject){
        Assert.notNull(statement,"statement can't null");
        Assert.notNull(mapKey,"mapKey can't null");
        Class<T> clazz =  (Class<T>)((ParameterizedType)getClass().getGenericSuperclass()).getActualTypeArguments()[0];
        // TODO: 2017/8/17 0017 后期完善查询条件，以及分页
        Map<String ,Map<String,String>> resultMap = getSqlSession().selectMap(statement,mapKey);
